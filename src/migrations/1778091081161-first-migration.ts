...
export class FirstMigration1778091081161 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "job" ("created_by_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_by_id" uuid, "updated_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, "deleted_by_id" uuid, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "job_no" character varying(50) NOT NULL, "job_serial" integer NOT NULL, "factory_id" uuid NOT NULL, "buyer_id" uuid NOT NULL, "merchandiser_id" uuid, "ordertype" "public"."job_ordertype_enum", "total_po_qty" numeric(18,4) NOT NULL DEFAULT '0', "po_receive_date" date, "is_active" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_98ab1c14ff8d1cf80d18703b92f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "job_details" ("created_by_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_by_id" uuid, "updated_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, "deleted_by_id" uuid, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "job_id" uuid NOT NULL, "po_id" uuid NOT NULL, "style_id" uuid NOT NULL, "size_id" integer NOT NULL, "color_id" integer NOT NULL, "quantity" numeric(18,4) NOT NULL DEFAULT '0', "fob" numeric(18,4) NOT NULL DEFAULT '0', "cm_per_dzn" numeric(18,4) NOT NULL DEFAULT '0', "delivery_date" date, "cutting_limit_percentage" numeric(18,4) NOT NULL DEFAULT '0', "remarks" text, CONSTRAINT "PK_daf4f98fa9373023a8e6cba51f8" PRIMARY KEY ("id"))`);
